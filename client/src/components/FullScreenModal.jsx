...
class FullScreenModal extends React.Component {
    ...
    render() {
        ...
        const showOrHide = modalActive ? "modal" : "display-none";
        return (
            <React.Fragment>
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <div id={styles.carousel}>
                            <div className={styles.carouselArrows}>
                                <button onClick={this.previousImage} className={styles.leftArrow}>
                                    <svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false" style={styleValues}>
                                        <path d="m13.7 16.29a1 1 0 1 1 -1.42 1.41l-8-8a1 1 0 0 1 0-1.41l8-8a1 1 0 1 1 1.42 1.41l-7.29 7.29z" fillRule="evenodd">
                                    </path>
                                    </svg>
                                </button>
                                <button  onClick={this.nextImage} className={styles.rightArrow}>
                                    <svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false" style={styleValues}>
                            ...
                            <span>
                                <div>
                                    <img className={styles.carouselImg} src={images[imageIndex].image_url}/>
                                </div>
                            </span>
                        </div>
